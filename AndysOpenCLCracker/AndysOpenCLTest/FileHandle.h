...
{
	// Only really put this in another lib to play about with PE exports / imports etc...
	class FileHandle
	{
	public:
		FileHandle(void);
		~FileHandle(void);
		static std::string ReadFile(std::string fileLoc);
		static const char ** ReadFile2(char fileLoc[]);
	};
}
#endif;